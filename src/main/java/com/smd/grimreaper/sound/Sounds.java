package com.smd.grimreaper.sound;
...
public final class Sounds {
    private static final ResourceLocation loc_reaper_scythe_out = new ResourceLocation("grimreaper:reaper.scythe.out");
    public static final SoundEvent reaper_scythe_out = new SoundEvent(loc_reaper_scythe_out);
    private static final ResourceLocation loc_reaper_scythe_swing = new ResourceLocation("grimreaper:reaper.scythe.swing");
    public static final SoundEvent reaper_scythe_swing = new SoundEvent(loc_reaper_scythe_swing);
    private static final ResourceLocation loc_reaper_idle = new ResourceLocation("grimreaper:reaper.idle");
    public static final SoundEvent reaper_idle = new SoundEvent(loc_reaper_idle);
    private static final ResourceLocation loc_reaper_death = new ResourceLocation("grimreaper:reaper.death");
